...
$('#desk______controlid_____ .form-toolbar .button-export-excel').on('click', function (e) {
    ...
    excelInfo.Title = $('#desk______controlid_____ .form-title .billingual-wrapper').first().text();;
...
function _____controlid______ShowEditor(NewChecked) {
    ...
    if (_____controlid______Type == "USER" && NewChecked) {
        screenInfo.Id = "_____childcontrolid_____Add";
    }
    //screenInfo.Id = "_____childcontrolid_____Add"
    screenInfo.Type = "listeditor";
    screenInfo.Dock = "none";
    ...
    if (!isNullOrEmpty(screenInfo.Id) && screenInfo.Id != 'null' && screenInfo.Id != '_____childcontrolid_____') {
        AddTab(screenInfo);
    }
}
