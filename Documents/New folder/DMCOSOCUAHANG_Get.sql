...
---GET PROCEDURE---
IF EXISTS(SELECT * FROM sysobjects WHERE [Name] = 'DMCOSOCUAHANG_Get')
	DROP PROCEDURE DMCOSOCUAHANG_Get
GO

CREATE PROCEDURE DMCOSOCUAHANG_Get
(
	@p_Code			T_D256,
	@p_Name			T_D256
)WITH ENCRYPTION
...
AS
BEGIN
	SELECT * FROM DMCOSOCUAHANG WHERE Code Like '%' + @p_Code + '%' and [Name] Like '%' + @p_Name + '%' 
END
