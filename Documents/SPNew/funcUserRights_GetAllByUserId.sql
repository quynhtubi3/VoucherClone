...
ALTER FUNCTION [dbo].[funcUserRights_GetAllByUserId]
(
@p_UserId		T_ID
)
RETURNS  @rtnTable TABLE 
(
    Id T_ID, ParentId T_ID NULL, [Name] T_D256 NULL, IsEnabled1 T_BIT DEFAULT 1, IsEnabled2 T_BIT DEFAULT 1,
...
declare @p_RoleId		T_ID = NULL

select @p_RoleId = RoleId from GroupWareService.dbo.UserRoles where UserId = @p_UserId
...
DECLARE @TEMP TABLE (Id T_ID, ParentId T_ID NULL, [Name] T_D256 NULL, IsEnabled1 T_BIT DEFAULT 1, IsEnabled2 T_BIT DEFAULT 1,
	...
	BEGIN
		...
		UPDATE @TEMP SET
			...
			Right_1 = b.Right_1, Right_2 = b.Right_2, Right_3 = b.Right_3, Right_4 = b.Right_4, Right_5 = b.Right_5--QuachPhu 20230518: Bo cam quyen theo nhom di
		FROM @TEMP a JOIN
			(
				SELECT DISTINCT
						FuncId AS Id, Right_1, Right_2, Right_3, Right_4, Right_5
