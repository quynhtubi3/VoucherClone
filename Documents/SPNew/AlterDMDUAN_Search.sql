...
--20230706
	...
	SET @SQLString = @SQLString + ' WHERE UP.HoVaTen Like N''%' + @p_Value + '%'' OR U.Email2 Like ''%' + @p_Value + '%'' OR DU.Code Like ''%' + @p_Value + '%'' OR DU.SoHopDong Like N''%' + @p_Value + '%'' OR DU.[Name] Like N''%' + @p_Value + '%'' OR KH.[Name] Like N''%' + @p_Value + '%'''	
