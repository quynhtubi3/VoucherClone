...
ALTER PROCEDURE UserLuongThang_GetAll 
...
--20230807
	SELECT distinct UserProfile.Id,
			...
			--MA-20230609: GiamTruCaNhan
			SML.GIAMTRUGIACANH as GiamTruGiaCanh,
		...
		--MA-20230609: order, group
		ORDER BY DMPHONGBAN.[Name], tblUser.UserName2
END
